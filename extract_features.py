...
if __name__ == "__main__":
    ...
    # python3 extract_features.py --input_file ../data/1.txt --output_file ../data/2.txt --vocab_file ../bert/vocab.txt --bert_config_file ../bert/bert_config.json --init_checkpoint ../bert/bert_model.ckpt
    tf.app.run()
