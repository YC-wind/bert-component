...
def freeze_graph(model_folder, output_graph="frozen_model.pb"):
    ...
    with tf.Session() as sess:
        ...
        output_graph_def = graph_util.convert_variables_to_constants(
            ...
            sess.graph_def,
            "loss/Softmax".split(",") # The output node names are used to select the usefull nodes
        )
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Tensorflow graph freezer\nConverts trained models to .pb file",
                                     prefix_chars='-')
    parser.add_argument("--mfolder", type=str, help="model folder to export", default="./bin_divorce_1")
